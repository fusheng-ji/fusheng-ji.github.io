...
![](/image-20200327210930605.png)

将MinGW地址选中，使其中的lib可以正常被调用

![](/image-20200327211009520.png)

编译器默认采用GNU GCC编译器，有些17.12版本不自带GCC编译器，如果发现建好项目后提示未找到编译器，则有可能是以上情况，建议安装官网自带C/C++编译器版本

![](/image-20200327211108015.png)

建好项目后，开始进行库的连接

- SEETINGS——COMPILER——LINKER SEETINGS——LINK LIBRARIES
- 点击ADD添加如下文件
- ![](/image-20200327211705117.png)
- ![](/image-20200327211154688.png)
- 点击OK
- 此时项目建立好后会自动生成一个MAIN文件，里面含有OPENGL库中的一些预览功能
- ![](/image-20200327211839460.png)
- 在编译之前为了避免报错
- 在文件开头添加如下两行代码
- #define _STDCALL_SUPPORTED
  #define GLUT_DISABLE_ATEXIT_HACK
- 编译
- ![](/image-20200327212820575.png)

运行成功！！！

![](/image-20200327212850310.png)
